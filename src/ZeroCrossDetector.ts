...
export class ZeroCrossDetector {
  ...
  private readonly DEFAULT_INITIAL_SEARCH_LENGTH = 500; // Default search length (≈10–11ms at typical audio sample rates: 48kHz/44.1kHz) when no frequency estimate is available
