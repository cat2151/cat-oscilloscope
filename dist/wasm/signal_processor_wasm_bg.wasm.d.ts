...
export const waveformrenderdata_highlightedZeroCrossCandidate: (a: number) => number;
...
export const waveformrenderdata_zeroCrossCandidates: (a: number) => [number, number];
