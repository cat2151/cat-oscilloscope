...
export declare class WaveformPanelRenderer {
     ...
     */
    drawZeroCrossCandidates(ctx: CanvasRenderingContext2D, width: number, height: number, candidates: number[], displayStartIndex: number, displayEndIndex: number, highlightedCandidate?: number, phaseZeroIndex?: number, minCandidateIndex?: number, maxCandidateIndex?: number): void;
    /**
     * Clear a canvas
     */
