...
※ This document is a placeholder, and a large portion was generated by an LLM. It will be revised in the future.

## Notes

- Frequency Estimation
  - There are cases where FFT is accurate, and cases where non-FFT methods are accurate.
  - Whether to make FFT the default is under consideration.
  - Further improvements to frequency estimation are deferred for now. Other numerous high-priority tasks will be prioritized.

## Features

- 🎤 **Microphone Input** - Captures audio from the microphone in real-time
- 🎯 **Zero-Crossing Detection** - Automatically detects points where audio crosses from negative to positive
...
4. Displays the waveform with slight padding around the zero-crossing points
...
- **Auto-Gain**:
  ...
  - Interpolation factor: 0.1 (for gradual adjustment)
