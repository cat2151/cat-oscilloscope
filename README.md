...
- 🎯 **Zero-Cross Detection** - Automatically detects points where the audio crosses from negative to positive
...
- 🎨 **Classic Design** - Black background with green waveform and grid overlay
- 🛡️ **Error Handling** - Gracefully handles microphone access permission issues
- 🔍 **Waveform Similarity Search** - Calculates similarity with previous frames to achieve a stable waveform display
- 🦀 **Rust/WASM Support** - Data processing implemented in Rust/WASM, toggleable via checkbox
