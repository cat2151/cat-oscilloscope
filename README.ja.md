...
- **一時停止の方法**: マウスクリックよりも、静音性の高いキーボードでスペースキーを使用することで、一時停止時の波形への影響を最小限に抑えることができます。
- **音源の選択**: マイク入力は環境音の影響を受けやすいため、クリーンな波形を観察したい場合は、WAVファイルなどのオーディオファイルを使用することをお勧めします。
